...
public class Carrera extends javax.swing.JFrame {
    ...
    void cargar(){
    nombretxt.setText(nombre);codcarreratxt.setText(cod);
}
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("FORMULARIO - CARRERA");
        ...
        jLabelNocontrol.setText("CODCARRERA:");
        ...
        getContentPane().add(codcarreratxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 330, -1));
        ...
        getContentPane().add(jButtonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 410, -1, -1));
        ...
        getContentPane().add(jButtonCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 410, -1, -1));
        ...
        getContentPane().add(jButtondelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 390, 70, 70));
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        try {
        // TODO add your handling code here:
        String sql="select agregarCarrera('"+codcarreratxt.getText()+"','"+nombretxt.getText()+"')";
    ...
    private void jButtondeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtondeleteActionPerformed
        ...
        try {
            String sql = "delete from carrera where codcarrera = '"+codcarreratxt.getText()+"'";
            st = cConexion.createStatement();
